...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'gannaramdhruv3@gmail.com',
    href: 'mailto:gannaramdhruv3@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 89779 99348',
    // wa.me requires digits only — no +, no spaces, no hyphens
    href: 'https://wa.me/918977999348',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/gannaramdhruv',
    href: 'https://www.linkedin.com/in/gannaramdhruv/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@Dhruv-git-tech',
