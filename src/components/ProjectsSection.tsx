...
const PROJECTS: ProjectData[] = [
  {
    number: '01',
    category: 'Computer Vision · ML (SIH 2025 Top 50)',
    name: 'NatyaBhoda',
    liveUrl: 'https://github.com/Dhruv-git-tech/NatyaBhoda',
    col1Image1: '/natya1.png',
    col1Image2: '/natya2.png',
    col2Image: '/natya1.png',
  },
  {
    number: '02',
    category: 'Low-Resource Telugu NLP · Agentic RAG',
    name: 'Chandamama 2.0',
    liveUrl: 'https://github.com/Dhruv-git-tech/telugu-agentic-rag',
    col1Image1: '/chanda1.png',
    col1Image2: '/chanda1.png',
    col2Image: '/chanda1.png',
  },
  {
    number: '03',
    category: 'Full Stack · Firebase · NLP · TTS',
    name: 'ManaKatha',
    liveUrl: 'https://github.com/Dhruv-git-tech/manakatha',
    col1Image1: '/manakatha1.png',
    col1Image2: '/manakatha1.png',
    col2Image: '/manakatha1.png',
  },
  {
    number: '04',
    category: 'Federated Learning · Privacy AI · HealthTech',
    name: 'Federated AI',
    liveUrl: 'https://github.com/Dhruv-git-tech/Federated-learning-healthcare-app',
    col1Image1: '/federated1.png',
    col1Image2: '/federated1.png',
    col2Image: '/federated1.png',
  },
];
